                ...
                <div class="card">
                    ...
                    <form action="" method="post">
                        <div class="card-body">
                            ...
                            <!-- button -->
                            <div class="row mb-3">
                                <button type="submit" class="btn btn-primary" name="btnDaftar">Daftar</button> <!-- name, type -->
                            </div>
                        <div>
                    </form>
                    </div>
...
if(isset($_POST['btnDaftar'])) { //kalau klik daftar
    $username=$_POST['username']; //inisialisasi
    $password=password_hash($_POST['password'], PASSWORD_BCRYPT);

    $query=mysqli_query($konek,"INSERT INTO tb_user VALUES('$username','$password')"); //bikin query

    if($query){ //kalau query benar
         
        header('location:login.php'); //dialihkan ke login.php
